...
echo "   Release/Choroboros-Beta-v2.05-macOS-Universal.zip"
echo "3. Restart your DAW"
echo "4. Rescan plugins in your DAW"
echo ""
echo "⚠️  Note: Make sure the current beta bundle names are installed:"
echo "   - VST3: ~/Library/Audio/Plug-Ins/VST3/Choroboros Beta.vst3"
echo "   - AU: ~/Library/Audio/Plug-Ins/Components/Choroboros Beta.component"
echo "   If older pre-beta bundles still exist, remove those too before rescanning."
echo ""
