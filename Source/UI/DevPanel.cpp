    ...
    : editor(editorRef), processor(processorRef)
{
    ...
    addLayout(layoutSliderProps, "Track Start X", layout.sliderTrackStartX, 0, 800);
    addLayout(layoutSliderProps, "Track Start Y", layout.sliderTrackStartY, 0, 500);
    addLayout(layoutSliderProps, "Track End X", layout.sliderTrackEndX, 0, 800);
    addLayout(layoutSliderProps, "Track End Y", layout.sliderTrackEndY, 0, 500);
    addLayout(layoutSliderProps, "Slider Size (%)", layout.sliderSize, 10, 500);
    ...
    addPanelSection(layoutPanel, "Slider (X, Y, W, H) - Global", layoutSliderProps, true);
