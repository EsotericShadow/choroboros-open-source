...
struct LayoutTuning
{
    ...
    int mainKnobSize = 138; // Legacy fallback/default
    int mainKnobSizeGreen = 138;
    int mainKnobSizeBlue = 130;
    int mainKnobSizeRed = 143;
    int mainKnobSizePurple = 150;
    int mainKnobSizeBlack = 138;
    int knobTopY = 74;
    int knobTopYGreen = 74;
    int knobTopYBlue = 80;
    int knobTopYRed = 78;
    int knobTopYPurple = 75;
    int knobTopYBlack = 80;
    int rateCenterX = 102;
    ...
    int scrollWheelSensitivityPct = 25;
