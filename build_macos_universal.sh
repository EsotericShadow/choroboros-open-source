...
rm -rf Build Universal-Build Release/Choroboros-v1.0.1-macOS-Universal.zip
...
zip -r ../../../Release/Choroboros-v1.0.1-macOS-Universal.zip \
    VST3 AU Standalone
...
echo "📦 Package: Release/Choroboros-v1.0.1-macOS-Universal.zip"
echo "📊 Size: $(du -h Release/Choroboros-v1.0.1-macOS-Universal.zip | cut -f1)"
